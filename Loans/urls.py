...
from .views import create_loan, loan_details, dashboard, loans_list, fsp_profile, loan_beneficiaries, add_record\
    , add_sales_record, fs, fr, GeneratePdf, GenerateBalanceSheet
